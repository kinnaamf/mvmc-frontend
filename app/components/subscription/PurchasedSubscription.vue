<template>
  <div class="card-container py-3 px-[1.125rem] transition-all duration-300 ease-in-out overflow-hidden cursor-pointer"
    ...
    <div class="flex items-center justify-between">
      ...
      <div class="relative p-px rounded-full bg-gradient-to-br from-neutral-900 via-neutral-700 to-neutral-500">
        <div class="bg-neutral-400 rounded-full p-[0.625rem] icon-container">
          <IconHeartSolid :show-content="showContent" />
        </div>
      </div>
    </div>
